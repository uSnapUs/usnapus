class Event < ActiveRecord::Base
  ...
  CODE_BLACKLIST = %w(NICK OWEN BROCK LUKE TEAM HELP SUPPORT RESQUE PRIVACY WEBMASTER TERMS BLOG PRESS ABOUT USERS EVENTS ADMIN DEVICES CHANGE_CURRENCY WEDDINGSHOW)
